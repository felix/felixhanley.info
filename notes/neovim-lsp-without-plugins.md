---
title: Neovim Lsp usage without plugins
keywords: neovim
---

Recent versions of neovim do Lsp stuff out of the box.

This is all that is required in `init.lua` for Lsp hints and autocomplete:
